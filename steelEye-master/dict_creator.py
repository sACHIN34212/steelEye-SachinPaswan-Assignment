# "This
# script is developed
# with python 3.6 and it reads a downloaded file and uploads the data to s3 as a json file.
#
# AWS
# credentials
# should in place and write
# access
# for the configured bucket should be provided in order to run this script
# '''
import sys
import json
import requests
...
time_stamp_string = time.strftime("%Y%m%d-%H%M%S")
s3.Bucket('paswansachin').put_object(Key='data_' + time_stamp_string +'.json', Body=json.dumps(data_list, indent=4))
print("Data Send To S3 Bucket Successfully")